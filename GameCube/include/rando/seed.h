...
namespace mod::rando
{
    ...
    class Header
    {
       public:
        ...
        uint16_t getReturnPlaceSectionOffset() const { return this->returnPlaceSectionOffset; }
       ...
       private:
        ...
        /* 0x88 */ uint16_t returnPlaceSectionOffset;
        /* 0x8A */ uint16_t customTextHeaderSize;
        /* 0x8C */ uint16_t customTextHeaderOffset;
        /* 0x8E */ uint16_t maloShopDonationAmount;
        /* 0x90 */ uint8_t castleRequirements;
        /* 0x91 */ uint8_t palaceRequirements;
        /* 0x92 */ uint8_t mapClearBits;
        /* 0x93 */ uint8_t damageMagnification;
        /* 0x94 */ uint8_t totSwordRequirement;
        /* 0x95 */ uint8_t mirrorChamberEntrance;
        /* 0x96 */ uint8_t barrierReqCount; // See below for notes
        /* 0x97 */ uint8_t hcBkRequirement;
        /* 0x98 */ uint8_t hcBkReqCount; // See below for notes
        /* 0x99 */ uint8_t walletSize;
    } __attribute__((__packed__));
    ...
    class Seed
    {
       public:
        ...
        const ReturnPlaceSection* getReturnPlaceSectionPtr() const { return this->m_ReturnPlaceSection; }
