...
namespace mod::customMessages
{
    ...
    MSG_BEGIN_ARRAY(bigWalletFr)
        ...
        MSG_COLOR(MSG_COLOR_RED)
        //5,000 rubis
        "%" PRIu32 "\x20\x72\x75\x62\x69\x73"
        MSG_COLOR(MSG_COLOR_WHITE)
        //!
        "\x21"
    MSG_END();
    ...
    MSG_BEGIN_ARRAY(giantWalletPauseFr)
        ...
        "" "%" PRIu32 "\x20\x72\x75\x62\x69\x73"
    MSG_END();
