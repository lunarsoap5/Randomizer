...
namespace mod::customMessages
{
    ...
    MSG_BEGIN_ARRAY(bigWalletIt)
        ...
        MSG_COLOR(MSG_COLOR_RED)
        //5.000 Rupie 
        "%" PRIu32 "\x20\x52\x75\x70\x69\x65"
        MSG_COLOR(MSG_COLOR_WHITE)
        //! 
        "\x21"
    MSG_END();
    ...
    MSG_BEGIN_ARRAY(smallWalletPauseIt)
        ...
        "\x4F\x67\x67\x65\x74\x74\x6F\x20\x64\x65\x6C\x6C\x27\x69\x6E\x66\x61\x6E\x7A\x69\x61\x2E\x20\x50\x75\xF2\x0A\x63\x6F\x6E\x74\x65\x6E\x65\x72\x65\x20\x66\x69\x6E\x6F\x20\x61\x20" "%" PRIu32 "\x20\x52\x75\x70\x69\x65\x2E"
    MSG_END();
